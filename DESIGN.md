# Design notes — PennAir 2024 Shape Detection

> The long-form version: full reasoning, every failure and fix, and the complete narrative
> for each part. [`README.md`](README.md) is the concise summary.
>
